...
- [The CDK recording](https://spicypath.intentius.workers.dev/leftness-cdk), with a marker on the moment your code starts.
- [The chant recording](https://spicypath.intentius.workers.dev/leftness-chant), where the same search for your code comes back 0 matches — the whole strip dims because nothing qualifies.
