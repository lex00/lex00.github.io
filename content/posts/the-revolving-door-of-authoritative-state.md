...
{{< inline-svg src="carve-out-to-native.svg" alt="One path running left to right. A Terraform estate holding HCL and state is carved out into typed TypeScript that keeps no state and runs nothing. From there the build fans out to CloudFormation and Kubernetes YAML and ARM JSON which your platform already reads." >}}
...
- [Bring your Terraform estate into the agentic era](https://www.pulumi.com/blog/bring-your-terraform-estate-into-the-agentic-era/) from Pulumi
